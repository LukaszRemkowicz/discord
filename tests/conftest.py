...
def city_result_template():
    with open("tests/fixtures/template/search_res.html", "r") as f:
        file = f.read()
    return file
...
def city_result_template_no_res():
    with open("tests/fixtures/template/search_res_no_res.html", "r") as f:
        file = f.read()
    return file
...
@pytest.fixture
def city_response():
    with open("tests/fixtures/template/response.html", "r") as f:
        file = f.read()
    return file
